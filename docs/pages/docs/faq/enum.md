...
ChatGPT doesn't "think" as we do - it "understands" simple constructions and may be confused with lists. You can get more pieces of advice [from our article](https://enumhq.com/blog/posts/art-of-creating-great-prompts/)
...
#### How is this chatbot different from the Crisp AI chatbot?
Recently, Crisp introduced their own AI chatbot. While it looks appealing to use their native chatbot without dealing with any plugins, consider the following facts:

- The Crisp chatbot doesn't have so many useful settings like Enum chatbot: it doesn't have automation, look settings, custom prompt, fine AI settings for indexing and querying data, scheduling feature, customizable buttons, and many other features.
- To set up your Crisp AI chatbot, someone needs to pay at least $95/month where as with the Enum chatbot, you can start for free.
...
Please follow [our guide on installing the Crisp plugin](https://enumhq.com/docs/chat-plugins/crisp/crisp-installation).
...
4) Check your OpenAI account (for those who are on the "Key" plan). If you are out of your credits, no more calls to ChatGPT can be made until you pay (and you should pay in advance, they don't have "pay-as-you-go" option).
...
9) Check if you exceeded your Enum limits, you can find it on the *Limits/Usage* page accessing from the left menu:

![image](https://github.com/StubbornDeer/enum-docs-nextra/assets/91156314/7de38b81-f237-4a5c-b822-b2ffd565493e)

10) There could be outages of OpenAI. Check this page https://status.openai.com/history to see if it's the case.

11) Check if you set the chatbot to run only in the test environment. This setting can be found on the *Live test* tab of your chatbot:

![image](https://github.com/StubbornDeer/enum-docs-nextra/assets/91156314/59d66ec6-cfb3-4525-a949-8b41e369e0f4)

12) Check the icon of your chatbot. Crisp chat doesn't support images in the "base64" format even if they are rendered in the Enum dashboard, and throws an error every time it tries to render the icon. So, this is not working, and can cause the chatbot to stop:
...
#### The icon (avatar) is not showing for my chatbot after I changed it
There could be a couple of problems with your new icon (avatar):
