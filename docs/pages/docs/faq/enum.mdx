...
#### When I started indexing, everything went okay but then I got an error
If you see an error message while indexing, it may mean that something happened. Possible reasons:
