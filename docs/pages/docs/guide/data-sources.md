...
### Use the Crisp conversations as data sources


If you have installed the Crisp plugin, you can easily add the conversations as data sources. In the Crisp dashboard, find the Enum widget (it's called *Support AI Chatbot*):

![image](https://github.com/user-attachments/assets/27f36239-9ae9-40b7-a7cf-965623593ce2)

Click the section *Train the chatbot with this conversation*, then click the *Add this conversation* button. Then the Crisp modal window is open where you can delete messages that you don't want to be indexed (or have some private information) and edit them:

![image](https://github.com/user-attachments/assets/4f525528-4b9a-4b51-81c2-a25ce47cf635)

After preparing the conversation, enter the data source title, and click the *Add this conversation* button in the modal. The process of indexing may take up to several minutes (usually, it's just seconds) and you will see the corresponding message:

![image](https://github.com/user-attachments/assets/f087a1fb-4a93-4557-93b6-b2715753d4b5)

If you click the link you will be redirected to your dashboard where you can review and edit the newly created data source.

### Indexing webpages

After you find or add the pages to be indexed, select them and then click the *Start indexing* button. The stats of indexing pages will be updated automatically. All indexed pages will be unchecked.
