...
Let's review all these data source types.
...
<Callout>
We can crawl, read, and index your websites and web pages even if they are dynamic and formed on the client side, using JavaScript. If you find it's the case and our crawler doesn't read the content of your web pages, please let us know!
</Callout>
