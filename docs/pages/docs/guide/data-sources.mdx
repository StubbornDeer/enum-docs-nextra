...
If you have the Crisp plugin installed, you can easily add the conversations as data sources. In the Crisp dashboard, find the Enum widget (it's called *Support AI Chatbot*):
