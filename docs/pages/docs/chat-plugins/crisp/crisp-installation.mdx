...
4. The chatbot will be created and you will see its default settings:
  ...
  ![image](https://github.com/StubbornDeer/enum-docs-nextra/assets/91156314/131e3b57-da85-416f-af33-2a33ec125103)
...
To help you with setting up all the things that are necessary for the chatbot proper functioning, we provide a small check-list that can be found on the right top corner of the window:

![image](https://github.com/user-attachments/assets/e8cad80e-c136-428a-afc8-020fd688994d)
