...
Now you can change some settings that will help make your chatbot more "intelligent" (for more details, [see the next section](https://enum-docs-nextra-docs-git-main-stubborndeer.vercel.app/docs/chat-plugins/crisp/crisp-settings).
