...
### Install the Enum plugin
  ...
  1. To install the plugin, you must create a Crisp account, then navigate to the [Enum plugin installation page](https://app.crisp.chat/initiate/plugin/25681a39-9849-4887-8fb5-16b04ba0f8e9/).
  ...
  3. You will be redirected to the Enum's dashboard page. If you didn't register yet please click the registration link in the same window, and finish the registration process, then finish setting up a project as described in the section below.
