...
#### Chatbot name
This name is shown as grey text beside the chatbot's icon. On a paid plan, you may leave it empty or enter your name.

<Callout>This setting is disabled for the free plan.</Callout>
